...
urlpatterns = [
    ...
    path('demo/<str:sim_code>/<str:step>/<str:play_speed>/', translator_views.demo, name='demo'),
    path('replay/<str:sim_code>/<str:step>/', translator_views.replay, name='replay'),
    path('replay_persona_state/<str:sim_code>/<str:step>/<str:persona_name>/', translator_views.replay_persona_state, name='replay_persona_state'),
